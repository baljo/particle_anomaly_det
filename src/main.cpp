...
static const int target_class = 1; // Class 1, this is only used with classification projects, and to blink the user LED if this class is identified
...
void setup()
{
    ...
    ei_printf("Edge Impulse live inferencing (P2) example, modified by Thomas Vikstrom\n");
